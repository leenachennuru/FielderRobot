...
W=[-2   -1.5    2.4    1.5    2];
%W=[-1.7850   -1.5267    2.3586    1.4735    1.8217
%V=rand(J,I);
%W=[-1 1 -1];
...
p=1;
W=[-2.0651   -1.6671    2.1635    1.8785    1.8217]
V=[1.5148    0.2037    0.5988;-0.0992    1.2819    0.4921;1.2242    0.2140   -0.4054;-0.2604    1.5333   -0.6417]
while p<=n1
